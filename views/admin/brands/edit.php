                        ...
                        <div class="mb-3 text-center" id="preview">
                            <?php if (!empty($brand->image)): ?>
                                <div class="d-inline-block position-relative">
                                  <img src="/MINISHOP_TRANTHINGOCYEN/uploads/brands/<?= htmlspecialchars($brand->image) ?>" alt="Brand Logo" class="img-thumbnail rounded shadow-sm" style="max-width: 120px; height: 120px; object-fit: cover;">
