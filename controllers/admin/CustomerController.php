            ...
            if (empty($fullName)) {
                ...
                try {
                    ...
                    if ($this->customerDAO->update($customer)) {
                        header("Location: index.php?controller=customer&action=index&msg=update_success");
                        exit();
                    } else {
            ...
            if (empty($fullName)) {
                ...
                try {
                    ...
                    if ($this->customerDAO->insert($customer)) {
                        header("Location: index.php?controller=customer&action=index&msg=insert_success");
                        exit();
                    } else {
            ...
            if ($id > 0) {
                try {
                    if ($this->customerDAO->delete($id)) {
                        header("Location: index.php?controller=customer&action=index&msg=delete_success");
                        exit();
                    } else {
